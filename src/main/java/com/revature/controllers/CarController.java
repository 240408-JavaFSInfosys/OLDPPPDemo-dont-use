...
@RestController // This makes a Class bean, and also converts request data to JSON automatically
...
public class CarController {
    ...
    //we need to inject the CarDAO bean into this Controller. We need to build a constructor
    public CarController(CarDAO carDAO){
        this.carDAO = carDAO;
    }

    //this method will insert a car into the database
    //it returns a ResponseEntity, which is a wrapper for HTTP data transfer
    @PostMapping() // this method is set to handle POST requests ending in /cars
